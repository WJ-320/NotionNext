...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '江', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '江的个人博客', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'wj32030.eu.org', // 网站地址
